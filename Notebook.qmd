...
Vergleich der Transkripte mit den Transkripten von @morton_fitzsimons_sivaramakrishan_jepson_niven_2024. BERTopic benutzen, weil siehe @grootendorst_2022. Für die Analyse von qualitativen Daten mit AI und virtuellen Fokusgruppen, siehe @olawade_omeni_gore_hadi_2025.

Am liebsten würde man genau das gleiche mit AI Gruppe und menschlicher Gruppe wie bei @zhang_zhang_cools_simeone_2024 machen.

@fig-heatmap @tbl-topics

thematic analysis/code [@braun_clarke_2021]

Für hdbscan Microsoft C++14.0 is required. Get it with "Microsoft C++ Build Tools": https://visualstudio.microsoft.com/visual-cpp-build-tools/
...
::: {.content-visible when-format="gfm"}
![Heatmap - Semantic Cosine Similarity Across 20 Top Topics](fig_heatmap.png){#fig-heatmap fig-cap="Heatmap - Semantic Cosine Similarity Across 20 Top Topics"}
:::

::: {.content-visible when-format="pdf"}
![Heatmap - Semantic Cosine Similarity Across 20 Top Topics](fig_heatmap.png){fig-cap="Heatmap - Semantic Cosine Similarity Across 20 Top Topics"}
:::

::: {.content-visible when-format="gfm"}
![Transcripts - Topics and Topic Frequency](fig_chunks.png){#fig-chunks fig-cap="Transcripts - Topics and Topic Frequency"}
:::

::: {.content-visible when-format="pdf"}
![Transcripts - Topics and Topic Frequency](fig_chunks.png){fig-cap="Transcripts - Topics and Topic Frequency"}
:::
...
Zum Beispiel über das andere Fokurgruppenpapier schrieben, dass meine Transitionlogik natürlicher ist und diese auch noch weitere Schwachstellen ausgemacht haben. Auch haben die im Gegensatz zu mir die Messagestruktur anders genutzt, was ich etwas schwierig finde. Dazu diskutieren. Auch diskutieren, dass man immer das Problem hat, ob man Leute sehr strak oder praktisch gar nicht prompten soll. Das hat aber trotzdem den Vorteil, dass das mit den unterschiedlichen Formen von Fokusgruppen (Fachbereiche unter sich oder ganz unterschiedliche Leute in einer Fokusgruppe) super kompatibel ist. Auch wenn es schwierig ist bestimmte Charaktere zu bekommen, kann man die einfach mit AI Agenten simulieren. Auch sich darauf beziehen, dass Leute gerne mit AIs interagiere. Zukünftige Schritte wären Spracherweiterung und Videosimulation der AI. Vorteil ist auch, dass AI Agents prinzipiell keiner Sample Selection unterliegen, also sich nicht rausselektieren können. Es ist allerdings die Frgae, ob so ein Verhalten vielleicht isch auch in der Datenebene mit denen die AI Agenten trainiert sind wiederspiegelt. Siehe Limitations von @morton_fitzsimons_sivaramakrishan_jepson_niven_2024.

Für die Diskussion oder Conclusion verweise auch auf @zhang_zhang_cools_simeone_2024.
